        ...
        <div class="wrapper">
            ...
            <div class="card">
                <div class="hero">
                    ...
                    <p class="hero-sub">
                        Use the code below to complete your sign-up and access
                ...
                <div class="body">
                    <p class="greeting">
                        Hi Doctor, we received a request to verify your email.
                        Enter the one-time code below — it's valid for the next
                        10 minutes.
                    </p>
                    <div class="otp-block">
                    ...
                    <div class="warning-note">
                        ⚠ InvoHealth will <strong>never</strong> ask for this
                        code via phone or chat. If someone is requesting it, do
                        not share it.
                    </div>
                    <div class="rule"></div>
                ...
                <div class="bottom">
                    <div class="bottom-links">
                        <a href="https://invohealth.vercel.app/terms"
                            >Terms and Conditions</a
                        >
                        <a href="https://invohealth.vercel.app/privacy"
                            >Privacy Policy</a
                        >
                    </div>
            ...
            <p class="legal">
                This email was sent because an account was created using your
                address.<br />If this wasn't you, you can safely ignore this
                message.
            </p>
        </div>
    </body>
